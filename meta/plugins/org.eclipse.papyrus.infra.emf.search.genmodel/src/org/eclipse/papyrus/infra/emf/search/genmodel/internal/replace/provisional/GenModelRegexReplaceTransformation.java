 ...
 * 
 ******************************************************************************/
package org.eclipse.papyrus.infra.emf.search.genmodel.internal.replace.provisional;
...
public class GenModelRegexReplaceTransformation extends
	...
	public GenModelRegexReplaceTransformation(GenBase element, IModelSearchQuery query, String valuation) {
	...
	public IStatus perform() {
		try {
			if (getQuery() instanceof EcoreModelSearchQuery) {
				...
				EObject o = ((GenBase)getModifiedElement()).getEcoreModelElement();
	...
	public String getResult() {
		return ((ENamedElement)((GenBase)getModifiedElement()).getEcoreModelElement()).getName();
	}
}
