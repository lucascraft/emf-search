...
import org.eclipse.emf.search.core.services.ModelSearchScopeDescriptor;
import org.eclipse.emf.search.core.services.ModelSearchScopeExtensionManager;
...
public abstract class AbstractModelSearchPage extends DialogPage implements 
	...
	private IModelSearchScope<?, Resource> computeModelSearchWorkspaceScope(IModelSearchQueryParameters parameters){
		...
		ModelSearchScopeDescriptor desc = ModelSearchScopeExtensionManager.getInstance().find("org.eclipse.emf.search.ModelScopeFactory");
