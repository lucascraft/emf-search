 ...
 * 
 * CaseSensitiveFilteredGenModelQueryHelperTestCase.java
 * 
 * Contributors:
...
public class CaseSensitiveFilteredGenModelQueryHelperTestCase extends TestCase {
	private IModelSearchQuery query;
	private IModelSearchScope<Object, Resource> scope;
	
	public CaseSensitiveFilteredGenModelQueryHelperTestCase(String testName) {
		super(testName);
	}
	...
	public void testCreateWorkspaceModelFilteredCaseSensitiveSearchQuery() {
		query = GenModelTextualModelSearchQueryBuilderHelper.getInstance().buildFilteredCaseSensitiveModelSearchQuery("*", GenModelPackage.Literals.GEN_CLASS, scope, EcorePackage.eNS_URI);
	...
	private void _testRunWorkspaceModelFilteredCaseSensitiveSearchQuery(String pattern, int nbMatch, EClassifier participant) {
		query = GenModelTextualModelSearchQueryBuilderHelper.getInstance().buildFilteredCaseSensitiveModelSearchQuery(pattern, participant, scope, EcorePackage.eNS_URI);
	...
	public void testRunWorkspaceModelFilteredCaseSensitiveSearchQuery1() {
		_testRunWorkspaceModelFilteredCaseSensitiveSearchQuery("*", 56, GenModelPackage.Literals.GEN_CLASS);
	}
	
	public void testRunWorkspaceModelFilteredCaseSensitiveSearchQuery2() {
		_testRunWorkspaceModelFilteredCaseSensitiveSearchQuery("Document*", 5, GenModelPackage.Literals.GEN_CLASS);
	}
	public void testRunWorkspaceModelFilteredCaseSensitiveSearchQuery3() {
		_testRunWorkspaceModelFilteredCaseSensitiveSearchQuery("DOCUMENT*", 0, GenModelPackage.Literals.GEN_CLASS);
	}
}
