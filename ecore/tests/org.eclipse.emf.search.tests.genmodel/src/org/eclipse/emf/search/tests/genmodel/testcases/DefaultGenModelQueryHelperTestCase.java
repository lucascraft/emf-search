 ...
 * 
 * DefaultGenModelQueryHelperTestCase.java
 * 
 * Contributors:
...
public class DefaultGenModelQueryHelperTestCase extends TestCase {
	private IModelSearchQuery query;
	private IModelSearchScope<Object, Resource> scope;
	
	public DefaultGenModelQueryHelperTestCase(String testName) {
		super(testName);
	}
	...
	public void testCreateWorkspaceModelSimpleTextualSearchQuery() {
		query = GenModelTextualModelSearchQueryBuilderHelper.getInstance().buildGlobalTextualModelSearchQuery("*", scope, EcorePackage.eNS_URI);
	...
	private void _testRunWorkspaceModelSimpleTextualSearchQuery(String regex, int nbMatch) {
		query = GenModelTextualModelSearchQueryBuilderHelper.getInstance().buildGlobalTextualModelSearchQuery(regex, scope, EcorePackage.eNS_URI);
	...
	public void testRunWorkspaceModelSimpleTextualSearchQuery1() {
		_testRunWorkspaceModelSimpleTextualSearchQuery("*", 289);
	}
