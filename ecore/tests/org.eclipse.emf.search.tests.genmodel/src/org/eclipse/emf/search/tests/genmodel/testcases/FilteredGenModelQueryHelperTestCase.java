 ...
 * 
 * FilteredGenModelQueryHelperTestCase.java
 * 
 * Contributors:
...
public class FilteredGenModelQueryHelperTestCase extends TestCase {
	private IModelSearchQuery query;
	private IModelSearchScope<Object, Resource> scope;
	
	public FilteredGenModelQueryHelperTestCase(String testName) {
		super(testName);
	}
	...
	public void testCreateWorkspaceModelFilteredTextualSearchQuery() {
		query = GenModelTextualModelSearchQueryBuilderHelper.getInstance().buildFilteredTextualModelSearchQuery("*", GenModelPackage.Literals.GEN_CLASS, scope, EcorePackage.eNS_URI);
	...
	public void testRunWorkspaceModelFilteredTextualSearchQuery1() {
		_testRunWorkspaceModelFilteredTextualSearchQuery("*", 56, GenModelPackage.Literals.GEN_CLASS);
	}
	
	public void testRunWorkspaceModelFilteredTextualSearchQuery2() {
		_testRunWorkspaceModelFilteredTextualSearchQuery("DocumentRoot", 5, GenModelPackage.Literals.GEN_CLASS);
	}
}
