 ...
 * 
 * CaseSensitiveFilteredEcoreQueryHelperTestCase.java
 * 
...
public class CaseSensitiveFilteredEcoreQueryHelperTestCase extends TestCase {
	private IModelSearchQuery query;
	private IModelSearchScope<Object, Resource> scope;
	
	public CaseSensitiveFilteredEcoreQueryHelperTestCase(String testName) {
		super(testName);
	}
	...
	public void testCreateWorkspaceModelFilteredCaseSensitiveSearchQuery() {
		query = new EcoreTextualModelSearchQueryBuilderHelper().buildFilteredCaseSensitiveModelSearchQuery("*", EcorePackage.Literals.ECLASS, scope, EcorePackage.eNS_URI);
	...
	private void _testRunWorkspaceModelFilteredCaseSensitiveSearchQuery(String pattern, int nbMatch, EClassifier participant) {
		query = new EcoreTextualModelSearchQueryBuilderHelper().buildFilteredCaseSensitiveModelSearchQuery(pattern, participant, scope, EcorePackage.eNS_URI);
	...
	public void testRunWorkspaceModelFilteredCaseSensitiveSearchQuery1() {
		_testRunWorkspaceModelFilteredCaseSensitiveSearchQuery("*", 59, EcorePackage.Literals.ECLASS);
	}
	
	public void testRunWorkspaceModelFilteredCaseSensitiveSearchQuery2() {
		_testRunWorkspaceModelFilteredCaseSensitiveSearchQuery("Document*", 5, EcorePackage.Literals.ECLASS);
	}
	public void testRunWorkspaceModelFilteredCaseSensitiveSearchQuery3() {
		_testRunWorkspaceModelFilteredCaseSensitiveSearchQuery("DOCUMENT*", 0, EcorePackage.Literals.ECLASS);
	}
}
