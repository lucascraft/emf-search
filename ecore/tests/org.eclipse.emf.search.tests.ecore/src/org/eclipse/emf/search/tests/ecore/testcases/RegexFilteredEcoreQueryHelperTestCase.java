...
public class RegexFilteredEcoreQueryHelperTestCase extends TestCase {
	private IModelSearchQuery query;
	private IModelSearchScope<Object, Resource> scope;
	
	public RegexFilteredEcoreQueryHelperTestCase(String testName) {
		super(testName);
	}
	...
	public void testCreateWorkspaceModelFilteredRegexSearchQuery() {
		query = new EcoreTextualModelSearchQueryBuilderHelper().buildFilteredRegexModelSearchQuery(".*", EcorePackage.Literals.ECLASS, scope, EcorePackage.eNS_URI);
	...
	private void _testRunWorkspaceModelFilteredRegexSearchQuery(String regex, int nbMatch, EClassifier participant) {
		query = new EcoreTextualModelSearchQueryBuilderHelper().buildFilteredRegexModelSearchQuery(
				regex, participant, scope, EcorePackage.eNS_URI);
	...
	public void testRunWorkspaceModelFilteredRegexSearchQuery1() {
		_testRunWorkspaceModelFilteredRegexSearchQuery(".*", 59, EcorePackage.Literals.ECLASS);
	}
	
	public void testRunWorkspaceModelFilteredRegexSearchQuery2() {
		_testRunWorkspaceModelFilteredRegexSearchQuery("Document.*", 5, EcorePackage.Literals.ECLASS);
	}
}
