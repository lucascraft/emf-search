	...
	private void createControl(Composite parent) {
		...
		javaRegexPatternUrlLink.addSelectionListener(new SelectionListener() {
			public void widgetSelected(SelectionEvent evt) {
				try {
					PlatformUI.getWorkbench().getHelpSystem().displayHelp("org.eclipse.emf.search.ecore.ui.EcoreTextModelSearchQueryArea"); //$NON-NLS-1$
				} catch (Exception e) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(qGrp, "org.eclipse.emf.search.ecore.ui.EcoreTextModelSearchQueryArea"); //$NON-NLS-1$
		PlatformUI.getWorkbench().getHelpSystem().setHelp(searchQueryLabel, "org.eclipse.emf.search.ecore.ui.EcoreTextModelSearchQueryArea"); //$NON-NLS-1$
		PlatformUI.getWorkbench().getHelpSystem().setHelp(searchQueryTextCombo, "org.eclipse.emf.search.ecore.ui.EcoreTextModelSearchQueryArea"); //$NON-NLS-1$
		PlatformUI.getWorkbench().getHelpSystem().setHelp(searchCaseSensitiveCheckBox, "org.eclipse.emf.search.ecore.ui.EcoreTextModelSearchQueryArea"); //$NON-NLS-1$
		PlatformUI.getWorkbench().getHelpSystem().setHelp(searchQueryExplanatoryLabel, "org.eclipse.emf.search.ecore.ui.EcoreTextModelSearchQueryArea"); //$NON-NLS-1$
		PlatformUI.getWorkbench().getHelpSystem().setHelp(searchRegularExpressionCheckBox, "org.eclipse.emf.search.ecore.ui.EcoreTextModelSearchQueryArea"); //$NON-NLS-1$
		PlatformUI.getWorkbench().getHelpSystem().setHelp(javaRegexPatternUrlLink, "org.eclipse.emf.search.ecore.ui.EcoreTextModelSearchQueryArea"); //$NON-NLS-1$
