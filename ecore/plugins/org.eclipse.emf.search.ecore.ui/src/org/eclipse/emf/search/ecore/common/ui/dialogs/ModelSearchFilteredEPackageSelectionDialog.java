 ...
 * 
 * ModelSearchFilteredEPackageSelectionDialog.java
 * 
...
import org.eclipse.emf.search.ecore.ui.factories.EcoreCommonUtils;
...
/**
 * Class responsible for EPackage selection.
 * 
 * @author <a href="mailto:lucas.bigeardel@gmail.com">Lucas Bigeardel</a>
 *
 */
public final class ModelSearchFilteredEPackageSelectionDialog extends
		AbstractModelSearchFilteredMetaElementsSelectionDialog {
	public ModelSearchFilteredEPackageSelectionDialog(Shell shell,
			boolean multi) {
		super(shell, multi);
	}
	@Override
	...
	protected List<EClassifier> getMetaElementParticipants() {
        return Arrays.asList(new EClassifier[] { EcorePackage.Literals.EPACKAGE });
	}
