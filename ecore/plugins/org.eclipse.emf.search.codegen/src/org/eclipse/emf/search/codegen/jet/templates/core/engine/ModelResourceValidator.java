...
public class ModelResourceValidator
{
  ...
  protected final String TEXT_1 = "package search.engine;" + NL + "" + NL + "import org.eclipse.emf.search.core.resource.AbstractModelResourceValidator;" + NL + "" + NL + "/**" + NL + " * Allows users to describe all the specific query search supported model editor extensions." + NL + " */" + NL + "public class ModelResourceValidator extends AbstractModelResourceValidator {" + NL + "\tpublic ModelResourceValidator() {" + NL + "\t\t";
