...
public class ModelSearchQueryBuilderHelper
{
  ...
  protected final String TEXT_9 = NL + "\tpublic IModelSearchQuery buildGlobalCaseSensitive";
  protected final String TEXT_10 = "ModelSearchQuery(" + NL + "\t\t\tString expr, IModelSearchScope<Object, Resource> scope) {" + NL + "\t\treturn buildTextualModelSearchQuery(" + NL + "\t\t\texpr," + NL + "\t\t\t";
  protected final String TEXT_11 = ".eINSTANCE.getEClassifiers()," + NL + "\t\t\tModelSearchQueryTextualExpressionEnum.CASE_SENSITIVE," + NL + "\t\t\tscope," + NL + "\t\t\t\"";
  protected final String TEXT_12 = NL + "\t" + NL + "\tpublic IModelSearchQuery buildGlobalTextualModelSearchQuery(String pattern," + NL + "\t\t\tIModelSearchScope<Object, Resource> scope, String nsURI) {" + NL + "\t";
  protected final String TEXT_13 = NL + "\t\tif (nsURI.equals(\"";
  protected final String TEXT_14 = "\")) { //$NON-NLS-1$" + NL + "\t\t\treturn buildGlobalTextual";
  protected final String TEXT_15 = "ModelSearchQuery(" + NL + "\t\t\t\tpattern," + NL + "\t\t\t\tscope" + NL + "\t\t\t);" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_16 = NL + "\t\treturn null;" + NL + "\t}" + NL + "" + NL + "\tpublic IModelSearchQuery buildGlobalRegexModelSearchQuery(String pattern," + NL + "\t\t\tIModelSearchScope<Object, Resource> scope, String nsURI) {" + NL + "\t";
  protected final String TEXT_17 = "\")) { //$NON-NLS-1$" + NL + "\t\t\treturn buildGlobalRegex";
  protected final String TEXT_18 = NL + "\t\treturn null;" + NL + "\t}" + NL + "" + NL + "\tpublic IModelSearchQuery buildGlobalCaseSensitiveModelSearchQuery(" + NL + "\t\t\tString pattern, IModelSearchScope<Object, Resource> scope," + NL + "\t\t\tString nsURI) {" + NL + "\t";
  protected final String TEXT_19 = "\")) { //$NON-NLS-1$" + NL + "\t\t\treturn buildGlobalCaseSensitive";
  protected final String TEXT_20 = NL + "\t\treturn null;" + NL + "\t}" + NL + "}";
