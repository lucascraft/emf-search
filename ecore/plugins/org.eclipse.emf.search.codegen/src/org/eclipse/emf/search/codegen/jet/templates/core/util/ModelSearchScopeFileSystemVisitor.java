...
public class ModelSearchScopeFileSystemVisitor
{
  ...
  protected final String TEXT_1 = "package search.util;" + NL + "" + NL + "import org.eclipse.emf.ecore.resource.Resource;" + NL + "import org.eclipse.emf.search.core.scope.IModelSearchScope;" + NL + "import org.eclipse.emf.search.ecore.scope.file.EcoreModelSearchScopeFileSystemVisitor;" + NL + "import java.io.File;" + NL + "" + NL + "public class ModelSearchScopeFileSystemVisitor extends" + NL + "\t\tEcoreModelSearchScopeFileSystemVisitor {" + NL + "" + NL + "\tpublic ModelSearchScopeFileSystemVisitor(" + NL + "\t\t\tIModelSearchScope<Object, Resource> scope, String engineID) {" + NL + "\t\tsuper(scope,  engineID);" + NL + "\t}" + NL + "\tprotected boolean isParticipantCurrentSearchEngineValid(File f) {" + NL + "\t\tif (f instanceof File && f.canRead() && f.exists() && ! f.isHidden()) {" + NL + "\t\t\t";
