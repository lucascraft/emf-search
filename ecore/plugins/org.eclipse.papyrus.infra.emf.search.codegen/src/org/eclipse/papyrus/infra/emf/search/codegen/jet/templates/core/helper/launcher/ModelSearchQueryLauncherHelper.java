package org.eclipse.papyrus.infra.emf.search.codegen.jet.templates.core.helper.launcher;
...
public class ModelSearchQueryLauncherHelper
{
  ...
  protected final String TEXT_1 = "package search.helper.launcher;" + NL + "" + NL + "import org.eclipse.core.runtime.NullProgressMonitor;" + NL + "import org.eclipse.emf.ecore.resource.Resource;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.engine.IModelSearchQuery;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.results.IModelSearchResult;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.scope.IModelSearchScope;" + NL + "import org.eclipse.papyrus.infra.emf.search.ecore.helper.launcher.EcoreModelSearchQueryLauncherHelper;" + NL + "import org.eclipse.papyrus.infra.emf.search.ecore.regex.ModelSearchQueryTextualExpressionEnum;" + NL + "" + NL + "public class ModelSearchQueryLauncherHelper extends EcoreModelSearchQueryLauncherHelper {" + NL + "" + NL + "\tprivate static ModelSearchQueryLauncherHelper instance;" + NL + "\t" + NL + "\t// Singleton" + NL + "\tpublic static ModelSearchQueryLauncherHelper getInstance() {" + NL + "\t\treturn instance==null?instance = new ModelSearchQueryLauncherHelper():instance;" + NL + "\t}" + NL + "\t" + NL + "\t//" + NL + "\t// NORMAL TEXT" + NL + "\t//" + NL + "\t";
  ...
  protected final String TEXT_8 = "ModelSearchQuery(String pattern, IModelSearchScope<Object, Resource> scope) {" + NL + "\t\tIModelSearchQuery q = buildTextualModelSearchQuery(" + NL + "\t\t\tpattern," + NL + "\t\t\t";
  ...
  protected final String TEXT_10 = "\" //$NON-NLS-1$" + NL + "\t\t);" + NL + "\t\tq.run(new NullProgressMonitor());" + NL + "\t\treturn q.getModelSearchResult();" + NL + "\t}" + NL + "\t";
  protected final String TEXT_11 = " " + NL + "\t" + NL + "\t//" + NL + "\t// CASE SENSITIVE" + NL + "\t//" + NL + "\t";
  protected final String TEXT_12 = NL + "\tpublic IModelSearchResult launchGlobalCaseSensitive";
  protected final String TEXT_13 = "ModelSearchQuery(String pattern, IModelSearchScope<Object, Resource> scope) {" + NL + "\t\tIModelSearchQuery q = buildTextualModelSearchQuery(" + NL + "\t\tpattern," + NL + "\t\t";
  ...
  protected final String TEXT_15 = "\" //$NON-NLS-1$" + NL + "\t);" + NL + "\t\tq.run(new NullProgressMonitor());" + NL + "\t\treturn q.getModelSearchResult();" + NL + "\t}" + NL + "\t";
