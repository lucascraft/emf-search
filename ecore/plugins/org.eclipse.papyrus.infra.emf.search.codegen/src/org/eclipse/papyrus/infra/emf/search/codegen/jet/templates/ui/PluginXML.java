...
public class PluginXML
{
  ...
  protected final String TEXT_1 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + NL + "<?eclipse version=\"3.2\"?>" + NL + "<plugin>" + NL + "   <extension" + NL + "         point=\"org.eclipse.papyrus.infra.emf.search.ui.modelSearchQueryTab\">" + NL + "      <queryTab" + NL + "            id=\"search.ui.";
  ...
  protected final String TEXT_3 = "PlainTextSearchExtPoint.Label\"" + NL + "            queryCompositeAreaFactory=\"org.eclipse.papyrus.infra.emf.search.ecore.ui.factories.EcoreTextModelSearchQueryAreaFactory\"" + NL + "            targetSearchPageID=\"search.ui.pages.";
  protected final String TEXT_4 = "ModelSearchPageID\"" + NL + "            tooltip=\"%";
  protected final String TEXT_5 = "PlainTextSearchExtPoint.Tooltip\"/>" + NL + "   </extension>" + NL + "   " + NL + "   <extension" + NL + "         point=\"org.eclipse.papyrus.infra.emf.search.ui.modelSearchParticipantTab\">" + NL + "         ";
  ...
  protected final String TEXT_18 = "ModelSearchPage.Label\"" + NL + "            showScopeSection=\"true\"" + NL + "            tabPosition=\"0\"/>" + NL + "   </extension>" + NL + "   " + NL + "   <extension" + NL + "         point=\"org.eclipse.papyrus.infra.emf.search.ui.modelSearchEngineMapping\">" + NL + " ";
