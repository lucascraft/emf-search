 ...
 * 
 * GenModelSearchCOREGeneratorAdapter.java
 * 
 ...
 *
 */
public final class GenModelSearchCOREGeneratorAdapter extends  AbstractModelSearchGenAdapter{
    
	  public GenModelSearchCOREGeneratorAdapter(GeneratorAdapterFactory generatorAdapterFactory)
	  {
	  ...
	  protected Diagnostic generateModelSearchStuff(ModelSearchGenSettings settings, Monitor monitor) {
		  try {
			  return new ModelSearchCoreGenerator(settings).generate(monitor);
