...
public class ManifestMF
{
  ...
  protected final String TEXT_2 = ".search;singleton:=true" + NL + "Bundle-Version: 1.0.0" + NL + "Bundle-Vendor: %providerName" + NL + "Bundle-Activator: search.Activator" + NL + "Bundle-Localization: plugin" + NL + "Require-Bundle: org.eclipse.core.runtime," + NL + " org.eclipse.core.resources," + NL + " org.eclipse.emf.ecore," + NL + " org.eclipse.papyrus.infra.emf.search," + NL + " org.eclipse.papyrus.infra.emf.search.common," + NL + " org.eclipse.papyrus.infra.emf.search.ecore,";
