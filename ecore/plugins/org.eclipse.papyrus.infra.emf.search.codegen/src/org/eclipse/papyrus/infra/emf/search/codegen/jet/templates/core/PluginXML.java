...
public class PluginXML
{
  ...
  protected final String TEXT_1 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + NL + "<?eclipse version=\"3.2\"?>" + NL + "" + NL + "<plugin>" + NL + "   <extension" + NL + "         point=\"org.eclipse.papyrus.infra.emf.search.modelSearchEngine\">" + NL + "      <modelSearchEngine" + NL + "            id=\"search.";
