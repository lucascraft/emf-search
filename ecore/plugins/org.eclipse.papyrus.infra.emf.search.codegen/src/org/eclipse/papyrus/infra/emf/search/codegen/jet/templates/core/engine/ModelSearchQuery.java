...
public class ModelSearchQuery
{
  ...
  protected final String TEXT_1 = "package search.engine;" + NL + "" + NL + "import java.util.ArrayList;" + NL + "import java.util.List;" + NL + "" + NL + "import org.eclipse.core.runtime.IStatus;" + NL + "import org.eclipse.core.runtime.Status;" + NL + "import org.eclipse.emf.ecore.EClassifier;" + NL + "import org.eclipse.emf.ecore.ENamedElement;" + NL + "import org.eclipse.emf.ecore.EObject;" + NL + "import org.eclipse.core.runtime.IProgressMonitor;" + NL + "import org.eclipse.core.runtime.NullProgressMonitor;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.engine.IModelSearchQuery;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.eval.IModelSearchQueryEvaluator;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.parameters.IModelSearchQueryParameters;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.results.IModelResultEntry;" + NL + "import org.eclipse.papyrus.infra.emf.search.ecore.engine.EcoreMetaModelIntrospector;" + NL + "import org.eclipse.papyrus.infra.emf.search.ecore.engine.EcoreModelSearchQuery;" + NL + "import org.eclipse.papyrus.infra.emf.search.ecore.results.EcoreModelSearchResultEntry;" + NL + "import org.eclipse.papyrus.infra.emf.search.ecore.utils.EcoreModelLoaderUtil;" + NL + "" + NL + "import search.Activator;" + NL + "import search.l10n.Messages;" + NL + "import search.evaluators.ModelTextualModelSearchQueryEvaluator;" + NL;
