 ...
 *
 * $Id: GeneratorAdapterFactory.java,v 1.3 2008/04/10 23:32:22 lbigearde Exp $
 */
...
public class GeneratorAdapterFactory extends AdapterFactoryImpl {
	...
	protected GeneratorSwitch<Adapter> modelSwitch =
		new GeneratorSwitch<Adapter>() {
			@Override
			public Adapter caseModelSearchGenSettings(ModelSearchGenSettings object) {
				return createModelSearchGenSettingsAdapter();
			}
			@Override
			public Adapter caseTextualSettings(TextualSettings object) {
				return createTextualSettingsAdapter();
			}
			@Override
			public Adapter caseEStringAccessor(EStringAccessor object) {
				return createEStringAccessorAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.infra.emf.search.codegen.model.generator.ModelSearchGenSettings <em>Model Search Gen Settings</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.infra.emf.search.codegen.model.generator.TextualSettings <em>Textual Settings</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.infra.emf.search.codegen.model.generator.EStringAccessor <em>EString Accessor</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
