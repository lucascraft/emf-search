package org.eclipse.papyrus.infra.emf.search.codegen.jet.templates.ui.pages;
...
public class ModelSearchPage
{
  ...
  protected final String TEXT_1 = "package search.ui.pages;" + NL + "" + NL + "import org.eclipse.emf.ecore.EObject;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.internal.replace.provisional.ITransformation;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.internal.replace.provisional.NullModelSearchTransformation;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.engine.IModelSearchQuery;" + NL + "import org.eclipse.papyrus.infra.emf.search.core.results.IModelResultEntry;" + NL + "import org.eclipse.papyrus.infra.emf.search.ui.pages.AbstractModelSearchPage;" + NL + "" + NL + "import search.replace.TextualReplaceTransformation;" + NL + "import search.util.TextualFeaturesUtils;" + NL + "" + NL + "public final class ModelSearchPage extends AbstractModelSearchPage {" + NL + "" + NL + "\t@Override" + NL + "\tprotected String getModelSearchPageID() {" + NL + "\t\treturn \"search.ui.pages.";
