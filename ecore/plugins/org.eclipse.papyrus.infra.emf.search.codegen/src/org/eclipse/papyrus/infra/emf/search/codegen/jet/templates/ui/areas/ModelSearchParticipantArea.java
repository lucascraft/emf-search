...
public class ModelSearchParticipantArea
{
  ...
  protected final String TEXT_1 = "package search.ui.areas;" + NL + "" + NL + "import java.util.ArrayList;" + NL + "import java.util.List;" + NL + "" + NL + "import org.eclipse.emf.common.notify.AdapterFactory;" + NL + "import org.eclipse.emf.ecore.provider.EcoreItemProviderAdapterFactory;" + NL + "import org.eclipse.emf.edit.provider.resource.ResourceItemProviderAdapterFactory;" + NL + "import org.eclipse.papyrus.infra.emf.search.ui.areas.AbstractModelSearchParticipantArea;" + NL + "import org.eclipse.papyrus.infra.emf.search.ui.pages.AbstractModelSearchPage;" + NL + "import org.eclipse.papyrus.infra.emf.search.ui.providers.AbstractMetaModelParticipantsItemProvider;" + NL + "import org.eclipse.swt.widgets.Composite;" + NL + "import org.eclipse.swt.graphics.Image;" + NL + "import org.eclipse.papyrus.infra.emf.search.utils.ModelSearchImagesUtil;" + NL + "import java.net.URL;" + NL + "" + NL + "import search.ui.Activator;" + NL + "" + NL + "import org.eclipse.core.runtime.FileLocator;" + NL + "import org.eclipse.core.runtime.Path;" + NL + "import org.eclipse.core.runtime.Status;" + NL + "" + NL + "import java.util.Collection;" + NL + "" + NL + "import search.util.TextualFeaturesUtils;" + NL + "" + NL + "import search.ui.providers.MetaModelParticipantsItemProvider;" + NL;
