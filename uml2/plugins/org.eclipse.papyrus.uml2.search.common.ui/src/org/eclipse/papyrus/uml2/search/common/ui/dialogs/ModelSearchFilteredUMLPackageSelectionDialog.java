 ...
 * 
 * ModelSearchFilteredUMLPackageSelectionDialog.java
 * 
 * Contributors: Lucas Bigeardel (Anyware Technologies) - initial API and
 * implementation
 ******************************************************************************/

package org.eclipse.papyrus.uml2.search.common.ui.dialogs;
...
import org.eclipse.papyrus.uml2.search.common.ui.Activator;
import org.eclipse.papyrus.uml2.search.engine.UML2TextualEngine;
import org.eclipse.papyrus.uml2.search.evaluators.UML2TextualModelSearchQueryEvaluator;
import org.eclipse.papyrus.uml2.search.ui.handlers.UML2EditorSelectionHandler;
...
/**
 * Class responsible for UML Package selection.
 * 
 * @author <a href="mailto:lucas.bigeardel@gmail.com">Lucas Bigeardel</a>
 *
 */
public final class ModelSearchFilteredUMLPackageSelectionDialog extends
		AbstractModelSearchFilteredMetaElementsSelectionDialog {
	public ModelSearchFilteredUMLPackageSelectionDialog(Shell shell,
			boolean multi) {
		super(shell, multi);
	}
	@Override
	protected boolean isAMetaElementToConsider(Object item) {
		if (item instanceof IModelResultEntry) {
			return ((IModelResultEntry)item).getSource() instanceof Package;
		}
		return false;
	}
    @Override
    protected List<EClassifier> getMetaElementParticipants() {
        return Arrays.asList(new EClassifier[] { UMLPackage.Literals.PACKAGE });
    }
