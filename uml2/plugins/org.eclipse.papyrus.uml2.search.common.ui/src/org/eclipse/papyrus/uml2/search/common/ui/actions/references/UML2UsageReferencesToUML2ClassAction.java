...
import org.eclipse.papyrus.uml2.search.common.ui.evaluators.references.UML2UsagesToUML2ClassModelSearchQueryEvaluator;
import org.eclipse.papyrus.uml2.search.common.ui.l10n.Messages;

public final class UML2UsageReferencesToUML2ClassAction extends
		AbstractUML2MetaElementReferenceSearchAction {

	public final static String ID = "uml2UsageReferencesSearchAction"; //$NON-NLS-1$

	public UML2UsageReferencesToUML2ClassAction() {
		super(Messages.getString("UML2UsageReferencesToUML2ClassAction.Label"), ID, ModelSearchImagesUtil.getImageDescriptor(Activator.getDefault().getBundle(), "icons/EReference.gif")); //$NON-NLS-1$ //$NON-NLS-2$
	}
	
	@Override
	protected IModelSearchQueryEvaluator<IModelSearchQuery, Resource> getEvaluator() {
		return new UML2UsagesToUML2ClassModelSearchQueryEvaluator<IModelSearchQuery, Resource>(getNamedElement());
	}
}
