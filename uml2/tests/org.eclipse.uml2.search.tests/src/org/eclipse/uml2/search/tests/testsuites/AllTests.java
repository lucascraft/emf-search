...
package org.eclipse.uml2.search.tests.testsuites;

import junit.framework.Test;
import junit.framework.TestSuite;

import org.eclipse.uml2.search.tests.testcases.CaseSensitiveFilteredUML2QueryHelperTestCase;
import org.eclipse.uml2.search.tests.testcases.DefaultUML2QueryHelperTestCase;
import org.eclipse.uml2.search.tests.testcases.ExhaustiveFilteredUML2QueryHelperTestCase;
import org.eclipse.uml2.search.tests.testcases.FilteredUML2QueryHelperTestCase;
import org.eclipse.uml2.search.tests.testcases.RegexFilteredUML2QueryHelperTestCase;

public class AllTests {

	public static Test suite() {
		TestSuite suite = new TestSuite("Test for org.eclipse.uml2.search.tests.testsuites");
