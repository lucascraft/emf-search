 ...
 * 
 * FilteredUML2QueryHelperTestCase.java
 * 
 * Contributors:
...
public class FilteredUML2QueryHelperTestCase extends TestCase {
	private IModelSearchQuery query;
	private IModelSearchScope<Object, Resource> scope;
	
	public FilteredUML2QueryHelperTestCase(String testName) {
		super(testName);
	}
	...
	public void testCreateWorkspaceModelFilteredTextualSearchQuery() {
		query = UML2TextualModelSearchQueryBuilderHelper.getInstance().buildFilteredTextualModelSearchQuery("*", UMLPackage.Literals.CLASS, scope, UMLPackage.eNS_URI);
	...
	public void testRunWorkspaceModelFilteredTextualSearchQuery1() {
		_testRunWorkspaceModelFilteredTextualSearchQuery("*", 80, UMLPackage.Literals.CLASS);
	}
	
	public void testRunWorkspaceModelFilteredTextualSearchQuery2() {
		_testRunWorkspaceModelFilteredTextualSearchQuery("DocumentRoot", 8, UMLPackage.Literals.CLASS);
	}
}
